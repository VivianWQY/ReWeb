...
namespace MiWeb.Infrastructs
{
    public static class BootstrapExtensions
    {
                                               ...
                                               IDictionary<string, object> htmlAttributes)
        {
            ...
            downButton.InnerHtml = "<span class=\"dropdown-label\"></span><span class=\"caret\"></span>";
            //create select list
            ...
            selectTagBuilder.MergeAttribute("data-resize", "auto");
            ...
            return new MvcHtmlString(selectTagBuilder.ToString(TagRenderMode.Normal));
        }
