...
Core.Upload = (function () {
    ...
    var _DisplayForm = new (function () {
        ...
        this.Success = function (file) {
            ...
            _cache.success_callback && _cache.success_callback(file);
        };
    ...
    var _FUpload = (function () {
        ...
        var setting = function (data) {
            ...
            var params;
            var postAid = data.aid, postCid = data.cid, postTid = data.tid;
            if (data.tid) {
                ...
                params = { aid: data.aid, tid: data.tid, cookie: USER_COOKIE };
            } else {
            ...
            if (!_FCache.Uploader) {
                ...
                if (!_FCache.isupload) {
                    ...
                    _FCache.Uploader.customSettings.tid = postTid;
                } else {
                    _FCache.Uploader.setUploadURL(url);
                    var postSetting;
                    if (data.tid ){
                        postSetting = { aid: postAid, tid: postTid, cookie: USER_COOKIE };
                    } else {
